...
\begin{enumerate}[label=\textbf{ Exhibit-\arabic*}]
    ...
    %     \item Current Passport's Biographical Page (Showing \textit{Sayka Sultana Mim} as Spouse)
...
% 4. Put the check on top of your I-485 form. You can probably use james clips or something. Just make sure that someone can find the check easily and quickly when they open your i-485 package. Check/payment is the first thing the USCIS center will look for.
    ...
    %     \item \hyperref[exhibit13a]{IRS Tax Return Transcripts for 2022 of Abrar Faiyaz}
    %     \item \hyperref[exhibit13b]{Fellowship Letter for 2023 of Abrar Faiyaz}
    % \end{enumerate}
